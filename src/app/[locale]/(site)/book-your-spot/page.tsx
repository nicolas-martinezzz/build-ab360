...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://yutopias.com/${locale}/book-your-spot`,
      languages: {
        es: "https://yutopias.com/es/reserva-plaza",
        en: "https://yutopias.com/en/book-your-spot",
        ca: "https://yutopias.com/ca/reserva-placa",
        "x-default": "https://yutopias.com/es/reserva-plaza",
      },
    },
  };
}
      ...
      <section className="section-block bg-surface-bg">
        <SectionContainer>
          <div className="max-w-2xl">
            ...
            <h1 className="figma-title-1 mt-3 text-white">{t("hero.title")}</h1>
            <p className="figma-text-l mt-4 text-white/70">{t("hero.body")}</p>
          </div>
        </SectionContainer>
      </section>
        ...
        <SectionContainer>
          <div className="mx-auto grid max-w-5xl gap-10 lg:grid-cols-[1fr_26.25rem] lg:items-start lg:gap-16">
            <div>
              ...
              <h2 className="figma-title-3 mt-3 text-surface-bg">{t("steps.title")}</h2>
              <p className="figma-text-m mt-3 text-surface-bg/60">{t("steps.body")}</p>
            ...
            <div className="rounded-[10px] border border-surface-bg/10 bg-white p-6 shadow-[var(--shadow-panel-lg)] sm:p-8 lg:sticky lg:top-24">
              ...
              <h3 className="figma-title-3 mt-2 text-surface-bg">{t("form.stepTitle")}</h3>
