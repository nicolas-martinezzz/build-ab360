...
export const SolutionRebuildPartnersBanner = async () => {
  ...
  return (
    <section className="relative flex min-h-[35.5625rem] items-center justify-center py-16">
      ...
      <SectionContainer className="relative z-10 text-center">
        <h2 className="mx-auto max-w-[61.3125rem] text-[2rem] font-normal leading-[1.35] text-white md:text-[2.5rem] md:leading-[1.45] lg:text-[3rem]">
          {t("headline")}
        </h2>
